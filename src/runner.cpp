    ...
    bool na_pad = false)
{
      ...
      at.size() == 0)
  {
    ...
    {
    case INTSXP:
      return aggr::cumstreak(as<IntegerVector>(x), lag(0), na_rm);
    case REALSXP:
      return aggr::cumstreak(as<NumericVector>(x), lag(0), na_rm);
    case STRSXP:
      return aggr::cumstreak(as<StringVector>(x), lag(0), na_rm);
    case LGLSXP:
      return aggr::cumstreak(as<LogicalVector>(x), lag(0), na_rm);
    default:
    {
  ...
  else
  {
    ...
    {
    case INTSXP:
      return runner_vec<13>(as<IntegerVector>(x),
                            aggr::calc_streak_i,
                            k, lag, idx, at, na_rm, na_pad);
    case REALSXP:
      return runner_vec<13>(as<NumericVector>(x),
                            aggr::calc_streak_n,
                            k, lag, idx, at, na_rm, na_pad);
    case STRSXP:
      return runner_vec<13>(as<StringVector>(x),
                            aggr::calc_streak_s,
                            k, lag, idx, at, na_rm, na_pad);
    case LGLSXP:
      return runner_vec<13>(as<LogicalVector>(x),
                            aggr::calc_streak_l,
                            k, lag, idx, at, na_rm, na_pad);
    default:
    {
                ...
                bool na_pad = false)
{
  ...
  {
  case INTSXP:
    return window_create(as<IntegerVector>(x), k, lag, idx, at, na_pad);
  case REALSXP:
    return window_create(as<NumericVector>(x), k, lag, idx, at, na_pad);
  case STRSXP:
