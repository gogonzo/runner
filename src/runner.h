...
namespace apply {
  IntegerVector get_window_idx(int i, int k, int lag) {
    if ((i - lag) < 0) return IntegerVector(0);
  ...
  IntegerVector get_dwindow_idx(IntegerVector idx, int i, int k) {
  ...
  IntegerVector get_dwindow_idx_lag(IntegerVector indexes, int i, int k, int lag) {
