...
This tutorial presents set of examples expaining how to tackle some tasks. Some of the examples are referenced to original topic on [stackoverflow](https://stackoverflow.com).
